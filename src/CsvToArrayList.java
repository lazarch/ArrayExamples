...
//                    System.out.println(daTemp.toString());
    ...
    private static DaTemp parseCSVLineToArray(String line) {   // метод, отримує line, повертає DaTemp
    ...
    private static DaTemp parseCSVLine(String line) {   // метод, отримує line, повертає DaTemp
        Scanner scanner = new Scanner(line);
        scanner.useDelimiter("\\s*,\\s*");
        String date = scanner.next();
        String time = scanner.next();
